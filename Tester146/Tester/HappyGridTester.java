...
public class HappyGridTester extends MarathonAnimatedVis {
  ...
  protected void generate() {
    ...
    if (parameters.isDefined("P"))
      P = randomInt(parameters.getIntRange("P"), minP * K, maxP * K);
    if (parameters.isDefined("W"))
      W = randomDouble(parameters.getDoubleRange("W"), minW, maxW);
  ...
  // check that all the balls are connected and that there is enough to make a
  // component in each colour
